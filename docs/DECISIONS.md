...
- **Laser pointer:** The presentation laser is a passive, transient red pointer that follows mouse movement without requiring a click, leaves a fading trail, and preserves normal taps/clicks. On touch devices, moved gestures belong to the laser instead of page scrolling so the teacher can scoop smoothly. It is never persisted, exported, or treated as student/lesson evidence.
