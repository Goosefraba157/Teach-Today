...
- **Laser pointer:** The presentation laser is a passive, transient red pointer that follows mouse movement without requiring a click, leaves a fading trail, and never blocks normal lesson interaction. It is never persisted, exported, or treated as student/lesson evidence.
