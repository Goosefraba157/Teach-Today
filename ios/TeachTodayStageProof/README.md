...
The browser-based Present and Student Stage flow remains unchanged. Inside the native shell, the existing Stage `Follow Lesson` control drives the external scene without opening a second teacher-facing window.
