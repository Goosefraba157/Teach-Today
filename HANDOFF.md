...
- Exact next step: wait for GitHub Pages/service-worker refresh, verify Day 1 and planned Day 2 dates survive a group switch, then smoke-test a confirmed prior-lesson date/number correction. Use Demo Group for future workflow testing and continue the presentation inventory afterward.
