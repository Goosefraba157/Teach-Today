...
- Exact next step: wait for GitHub Pages/service-worker refresh, verify Monday Day 1 defaults Day 2 to Tuesday and Thursday defaults to Monday, then confirm date overrides survive a group switch. Smoke-test Complete Lesson As Is and Plan a new lesson in Demo Group before continuing the presentation inventory.
